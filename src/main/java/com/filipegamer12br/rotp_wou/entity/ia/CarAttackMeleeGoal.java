...
//
//        // Calcular a direção da rotação necessária para o alvo em radianos
...
//
//        // Ajuste suave da rotação diretamente em radianos
//        float deltaRotation = wrapRadians(targetRotation - this.mob.yRotO); // yRotO será a rotação anterior em radianos
//        this.mob.yRotO += deltaRotation * 0.1F;  // Suavização do giro, ajuste o fator conforme necessário
//
//        // Se necessário, converter para graus para compatibilidade com sistemas do Minecraft
//        this.mob.yRot = this.mob.yRotO;
//
